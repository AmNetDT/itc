...
<div style="height: 280px; width: auto; overflow: scroll">
        ...
        $urn = ltrim($urno,'0');
          ...
          <tr id="<?php echo $stmp['auto'] ?>"  class="rowOdd btn_customers_all_cards my_card_update">
            ...
            <td width="49"><?php echo $stmp['contactphone']?><input name="a_i_syscat" type="hidden" value="<?php echo $stmp['contactphone'] ?>" class="cphone<?php echo $stmp['auto']?>" /></td></td>
 ...
 color:#224889;" >Update Customer Cards</div>
  ...
  <tr>
    <td width="157"><div id="inputName">Customer Name:</div></td>
    <td width="251"><div id="formInputs">
    <input name="fname_i_u" type="text" id="e_empty" class="fname_apps" readonly/></div></td>
    </tr>
  <tr>
    <td><div id="inputName">Contact Name:</div></td>
    ...
    <tr>
    <td><div id="inputName">Language:</div></td>
    <td><div id="formInputs">
    ...
    <td width="346" align="left" valign="top"><br>
      <table width="418" border="0" style="width:350px;">
      <tr>
    <td width="157"><div id="inputName">Phone:</div></td>
    <td width="251"><div id="formInputs"><input name="custcode_u_i" type="text" id="e_empty" class="cphone_app" readonly/></div></td>
    </tr>
  

     <tr>
    <td><div id="inputName">LatLng:</div></td>
    <td>
		<div id="formInputs">
      <input name="edcode_u_i" type="text" id="e_empty" class="clatlng" readonly/>
		  ...
		  <tr>
    <td><div id="inputName">Outlet Type:</div></td>
    <td><div id="formInputs">
    <input name="lastname_u_i" type="text" id="e_empty" class="ctype_app" readonly/>
    </div></td>
    </tr>
		<tr>
    <td><div id="inputName">Cust Class:</div></td>
    <td><div id="formInputs">
