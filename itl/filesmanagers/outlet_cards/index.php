...
<div id="accounttile">Customer Cards <span id="close"><img src="filesmanagers/jlib/cancel_icon.png"  /></span></div>
...
<table class="datatable" id="genericTableFormtable" summary="System Resources" style="width:100%;">
	...
	<?php 
		...
		$sn++;
    ?>
    <tr id="<?php echo $stmp['id'] ?>"  class="rowOdd btn_customers_cards
