...
<div id="accounttile">Users Modules <span id="close"><img src="filesmanagers/jlib/cancel_icon.png"  /></span></div>
...
<table class="datatable" id="genericTableFormtable" summary="System Resources" style="width:100%;">
	...
	<?php 
		...
		$sn++;
    ?>
    <tr id="<?php echo $stmp['id'] ?>"  class="rowOdd users_app_modules_dev rst<?php echo $stmp['id']?>" lang="<?php echo $stmp['fullname']." (".$stmp['ecode'].")" ?>">
