...
<body>
                ...
                <td>
                  <div id="formInputs">
                    <select name="sex_u_i" id="sex_u_i">
                      <option value="Male" <?php if (!(strcmp("Male", $e_result['sex']))) {
                                              echo "selected=\"selected\"";
                                            } ?>>Male</option>
                      <option value="Female" <?php if (!(strcmp("Female", $e_result['sex']))) {
                                                echo "selected=\"selected\"";
                                              } ?>>Female</option>
                    </select>
                  </div>
 ...
 color:#224889; margin-top:20px;">Device</div>
            <table width="418" border="0" style="width:350px;">
              <tr>
                ...
                <td width="251">
                  <div id="formInputs"><input name="phonefacode_u_i" type="text" id="phonefacode_u_i" value="<?php echo $e_result['phone_fa_code'] ?>" class="drclear" /></div>
                </td>
              </tr>
              <tr>
                <td>
 ...
 color:#224889;margin-top:20px;">Authentication</div>
            <table width="418" border="0" style="width:350px;">
                  ...
                  <div id="formInputs">
                    <select name="syscat_u_i" id="syscat_u_i">
                      ...
                      ?>
                        ...
                        <option value="<?php echo  $vresult['id'] ?>" <?php if (!(strcmp($vresult['id'], $e_result['syscategory_id']))) {
                                                                        echo "selected=\"selected\"";
                                                                      } ?>><?php echo $vresult['name'] ?>
                        </option>
                      <?php
                ...
                <td>
                  <div id="formInputs">
                    <select name="depotwaiver_u_i" id="depotwaiver_u_i" class="drclear">
                      <option value="true" <?php if (!(strcmp(true, $e_result['depots_waiver']))) {
                                              echo "selected=\"selected\"";
                                            } ?>>True (with geofencing)</option>
                      <option value="false" <?php if (!(strcmp(false, $e_result['depots_waiver']))) {
                                              echo "selected=\"selected\"";
                                            } ?>>False (without geofencing)</option>
                    </select>
                  </div>
                </td>
              </tr>
              ...
              <tr>
                <td>
                  <div id="inputName">Activate:</div>
                </td>
                <td>
                  <div id="formInputs">
                    <select name="activate_u_i" id="activate_u_i">
                      <option value="YES" <?php if (!(strcmp("YES", $e_result['activate']))) {
                                            echo "selected=\"selected\"";
                                          } ?>>YES</option>
                      <option value="NO" <?php if (!(strcmp("NO", $e_result['activate']))) {
                                            echo "selected=\"selected\"";
                                          } ?>>NO</option>
                    </select>
                  </div>
