...
<body>
 ...
 color:#224889;">Official Information</div>
        <table width="418" border="0" style="width:350px;">
          <tr>
            <td width="157">
              <div id="inputName">Customer Code:</div>
            </td>
            <td width="251">
              <div id="formInputs"><input name="custcode_u_i" type="text" id="custcode_u_i" value="" class="cust_codes drclear" /></div>
            </td>
          </tr>
          <tr>
            <td>
              <div id="inputName">ED Code:</div>
            </td>
            <td>
              <div id="formInputs">
