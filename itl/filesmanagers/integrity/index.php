...
<div id="body_general">
<div id="accounttile">Load Out VS Sales<span id="close"><img src="filesmanagers/jlib/cancel_icon.png"  /></span></div>
<p>&nbsp;</p>
<p>&nbsp;</p>
<table class="datatable" id="genericTableFormtable" summary="System Resources" style="width:100%;">
    <tr>
      ...
      <th width="176" id="datatableColcontent">Daily Customers</th>
    </tr>
	<?php 
		$sn = 0; 
